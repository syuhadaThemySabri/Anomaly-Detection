...
def detect_anomalies(file_path, eps=0.3, min_samples=40):
    """
    Detect anomalies in turbine performance data using DBSCAN.
    
    Parameters:
    file_path (str): Path to the CSV file containing the dataset.
    eps (float): The maximum distance between two samples for them to be considered as in the same neighborhood (default: 0.3).
    min_samples (int): The number of samples in a neighborhood for a point to be considered as a core point (default: 40).
    
    Returns:
    pandas.DataFrame: DataFrame with aggregated data, anomaly labels, and distance to nearest neighbor.
    """
    # Load the data
